        ...
        <div className="center-nav border-t border-[#eee]">
            <div className="w-[1280px] m-auto py-4 flex items-center justify-between">
                <div className="logo-wrap flex items-center gap-2">
                    ...
                    <div className="flex relative ml-[120px] w-[400px]">
                        <input
                            type="text"
                            placeholder="상품명을 검색해보세요."
                            className="w-full border border-[#2B6CEE] rounded-tl-sm rounded-bl-sm px-4 py-2 text-sm focus:outline-none focus:unset"
                            name="name"
                        />
