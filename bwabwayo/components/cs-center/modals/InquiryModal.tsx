...
export const InquiryModal = ({ isOpen, onClose }: InquiryModalProps) => {
  ...
  return (
    <OverlayPortal open={isOpen} onClose={onClose}>
        ...
        {/* 헤더 */}
        <div className="relative pt-[41px] pb-[25px]">
        ...
        {/* 문의 내용 입력 */}
                 <div className="px-[48px] pb-[14px]">
           <div className="w-[450px] h-[152px] border-[0.7px] border-[#A2A2A2] rounded-[20px] p-[13px]">
            <textarea
              value={description}
         ...
         <div className="px-[48px] pb-[20px]">
           <h3 className="text-[14px] font-semibold text-black font-['SUITE'] leading-[1.248] mb-[15px]">
             사진 첨부
           </h3>
                ...
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                            ...
                                            {/* 유의사항 */}
                     <div className="px-[45px] pb-[25px]">
           <div className="w-[450px] bg-[#F6F8F9] rounded-[20px] p-[20px] relative">
            <h3 className="text-[14px] font-semibold text-black font-['SUITE'] leading-[1.248] mb-[21px]">
              문의 작성 시 유의사항
            </h3>
            {/* 구분선 */}
            <div className="w-full h-[0.5px] bg-[#ACADB0] mb-[21px]"></div>
