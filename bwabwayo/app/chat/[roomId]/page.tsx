    ...
    <div className="h-full flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 bg-white border-b border-gray-200 z-2 flex flex-col px-5 py-4 gap-2">
        ...
        <div className="flex gap-2">
          <div className="w-10 h-10 bg-gray-200 flex items-center justify-center relative">
            <Image src="/image/no-image.jpg" alt="상품 이미지" fill className="object-cover" />
          </div>
      ...
      >
        <div className="mb-10 flex flex-col gap-2 items-center">
          <div className="w-[100px] h-[100px] bg-gray-200 rounded-full flex items-center justify-center overflow-hidden relative">
            <Image src="/image/no-image.jpg" alt="판매자 프로필" fill className="object-cover" />
          </div>
          <h1 className="text-[18px] font-bold text-black">고윤정</h1>
          <div className="flex items-center gap-1 mb-2">
            <p className="text-sm text-gray-500">4.8</p>
            <div className="relative w-4 h-4 pb-1"><Image src="/icon/star-on.svg" alt="별점" fill /></div>
